...
myapp.service('RegistraionService',function($rootScope, $http, $resource, authService, Session) {
					return {
						submitForm : function(userIdRegis, registrationPass,
								registrationRePass) {
							var config = {
								ignoreAuthModule : 'ignoreAuthModule',
								headers : {
