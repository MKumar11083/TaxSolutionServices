...
<body ng-app="myApp">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">
                    <img src="static/img/logo-new.jpg" alt="" style="padding-right: 0px;" width="30%">
                </a>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="#loginpage" style="color: white;">Login</a></li></sec:authorize>
					<!-- <li data-toggle="modal" data-target="#myModal"><a>Register</a></li> -->
					<!-- <li data-toggle="modal" data-target="#myModalLogin"><a>Login</a></li> -->
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
	...
	<footer>
		<div class="row">
			<div class="col-lg-12">
				<p align="center">Copyright &copy; 2018 Tax Solution Services
