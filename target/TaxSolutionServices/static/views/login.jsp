					...
					<div class="well">
						<fieldset>
							<div class="form-group label-floating"
								...
								<label class="control-label" for="login">User Id</label> 
								<input	type="text" id="login" class="form-control"	title="Please enter you username" placeholder="example@gmail.com" ng-model="ssoId" required="" />
							...
							<div>
								...
								<span> 
								<a href="#forgetpassword" class="btn btn-default">Forget Password</a>
								</span>
